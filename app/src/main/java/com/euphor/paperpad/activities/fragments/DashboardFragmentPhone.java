...
import com.euphor.paperpad.rss.RssServiceDashboardPhone;
...
public class DashboardFragmentPhone extends Fragment implements OnBufferingUpdateListener, OnPreparedListener, OnCompletionListener {
...
//	private int height;
	...
	private HashMap<Integer, ListView> map;
	private Timer timer;
	/**
	 * Create a new instance of MyDialogFragment
	 */
	public static DashboardFragmentPhone newInstance(Dashboard dashboard) {
		DashboardFragmentPhone f = new DashboardFragmentPhone();
...
//				if(widget.getType().equalsIgnoreCase("category") || widget.getType().equalsIgnoreCase("rss") ) {
//					widgetsViews.get(i).setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 250));
//				}
//			}
//		}
...
//	    listView.requestLayout();
	...
	public static int getListViewHeightBasedOnNbrItemsChildren(ListView listView, int nbrItems) {
	    ListAdapter listAdapter = listView.getAdapter();
...
//	    listView.requestLayout();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		//view.findViewById(R.id.widgetContainer).setBackgroundColor(colors.getColor(colors.getTitle_color(), "20"));
		ColorDrawable colorDrawable2 = new ColorDrawable(colors.getColor(colors.getForeground_color(), "20"));
		...
		LinearLayout _lContainer = new LinearLayout(getActivity());
		_lContainer.setOrientation(LinearLayout.VERTICAL);
		_lContainer.setScrollContainer(true);
		_lContainer.setVerticalScrollBarEnabled(true);
		LayoutParams _pms;
        ...
        if(dashboard!=null) {
            ...
            for (int i = 0; i < dashboard.getWidgets().size(); i++) {
                ...
                Landscape_layout port_layout = widget.getLandscape_layout();
                //int relW = port_layout.getWidth();
                int relH = port_layout.getHeight();
                int widgetWidth = android.widget.LinearLayout.LayoutParams.MATCH_PARENT;
                int widgetHeight = android.widget.LinearLayout.LayoutParams.WRAP_CONTENT; //(int)((float)relH*(((float)deviceHeight/(float)40)));
                _pms = new LayoutParams(widgetWidth, widgetHeight);
                _pms.leftMargin = 10;
                _pms.topMargin = (int) (((float) port_layout.getY()) * (((float) deviceHeight / (float) 40)));

                final RelativeLayout widgetContainer = new RelativeLayout(getActivity());
                widgetsViews.add(widgetContainer);

                if (widget.getType().equalsIgnoreCase("category") || widget.getType().equalsIgnoreCase("rss") || widget.getType().equalsIgnoreCase("room_service") && widgetContainer != null) {
//					LinearLayout.LayoutParams lytParam = (LinearLayout.LayoutParams)widgetContainer.getLayoutParams();
//					if(lytParam != null)
//						lytParam.bottomMargin = 15;
                    //this.widgetContainer = widgetContainer;
                    widgetHeight = android.widget.LinearLayout.LayoutParams.WRAP_CONTENT;
                    _pms = new LayoutParams(widgetWidth, widgetHeight);
                    _pms.leftMargin = 10;
                    _pms.topMargin = 10;
                }
                ...
                ((LinearLayout.LayoutParams) widgetContainer.getLayoutParams()).bottomMargin = 15;
                widgetContainer.setBackgroundColor(colors.getColor(colors.getTitle_color(), "10"));//.setBackgroundColor(colors.getColor(colors.getBackground_color(), "ff"));
                //this.widgetContainer = widgetContainer;
                _lContainer.addView(intermediare);
            ...
            LinearLayout.LayoutParams paramsRLContainer = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);

            scroll.addView(_lContainer);
            tilesContainer.addView(scroll, paramsRLContainer);
        }
	...
	public void drawWidgets(LayoutInflater inflater, int i,
			...
			final RelativeLayout widgetContainer, final RelativeLayout widgetContent,
...
//			widgetRss.findViewById(R.id.llSVFeedChoicesHolder).setBackgroundColor(colorDrawable2.getColor());
			widgetRss.findViewById(R.id.llSVFeedChoicesHolder).setBackgroundColor(colors.getColor(colors.getTitle_color(), "20"));
			RSSAdapter adapter = new RSSAdapter(getActivity(), new RssFeed(), colors, R.layout.widget_rss_list_item);
			adapter.setDahshboardPhone(true);
			final RssServiceDashboardPhone serviceDashboard = new RssServiceDashboardPhone(this, lvRss, adapter, bar);
			...
			final ImageView img1 =	(ImageView)widgetRss.findViewById(R.id.show_widget);
			final com.euphor.paperpad.widgets.ArrowImageView img2 =	(com.euphor.paperpad.widgets.ArrowImageView)widgetRss.findViewById(R.id.hide_widget);

			Paint paint_ = new Paint();
			paint_.setColor(colors.getColor(colors.getTitle_color()));
			//					paint_.setColor(colors.getColor("000000","AA"));
			img2.setPaint(paint_);

				//img.setVisibility(View.VISIBLE);
				img1.setTag("show");
				final Drawable selectDrawable = getResources().getDrawable(R.drawable.icon_1_2);
				selectDrawable.setColorFilter(colors.getColor(colors.getTitle_color()), Mode.MULTIPLY);
				img1.setBackgroundDrawable(selectDrawable);
				
				final Drawable selectDrawable2 = getResources().getDrawable(R.drawable.arrow_top);
				selectDrawable2.setColorFilter(colors.getColor(colors.getTitle_color()), Mode.MULTIPLY);

				OnClickListener listener = new OnClickListener() {
					
					@Override
					public void onClick(View v) {
						//Toast.makeText(getActivity(), " This click is on  "+v.getTag()+" ", 1000).show();
						ListView lv = map.get(widget.getId());
						if(v.getTag().equals("show")) {
							...
							LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnChildren(lv));
							lParams.bottomMargin = 15;
							widgetContainer.setLayoutParams(lParams);
							
	
							widgetContainer.requestLayout();
							
							
							//img1.setBackgroundDrawable(selectDrawable2);
							//img1.setTag("hide");
						}else {
							img1.setVisibility(View.VISIBLE);
							img2.setVisibility(View.GONE);
							LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnNbrItemsChildren(lv, 2));
							lParams.bottomMargin = 15;
							widgetContainer.setLayoutParams(lParams);
						}
...
//				img2.setBackgroundDrawable(selectDrawable2);
			...
			LinearLayout.LayoutParams lytParam = (LinearLayout.LayoutParams)linkWidget.getLayoutParams();
			if(lytParam != null)
				lytParam.setMargins(10, 10, 10, 10);
			...
			lParams.bottomMargin = 15;
			widgetContainer.setLayoutParams(lParams);
			//widgetContainer.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 250));
			...
			TextView timeTv = (TextView)calendar_widget.findViewById(R.id.textView4);
			...
			final ImageView img1 =	(ImageView)widgetContainer.findViewById(R.id.show_widget);
			final com.euphor.paperpad.widgets.ArrowImageView img2 =	(com.euphor.paperpad.widgets.ArrowImageView)widgetContainer.findViewById(R.id.hide_widget);
				...
				OnClickListener listener = new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(v.getTag().equals("show")) {
							...
							LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnChildren(lv)+ 60);
							lParams.bottomMargin = 15;
							widgetContainer.setLayoutParams(lParams);
							...
							img1.setVisibility(View.VISIBLE);
							img2.setVisibility(View.GONE);
							LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnNbrItemsChildren(lv, 1) + 20);
							lParams.bottomMargin = 15;
							widgetContainer.setLayoutParams(lParams);
						}
...
//				if(listRoomService.getAdapter().getCount() == 0) img1.setVisibility(View.GONE);
				
				widgetContent.addView(widgetRoom, RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
				
				LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnNbrItemsChildren(listRoomService, 1));
				lParams.bottomMargin = 15;
				widgetContainer.setLayoutParams(lParams);
				//widgetContainer.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, setListViewHeightBasedOnChildren(listRoomService)));

				map.put(widget.getId(), listRoomService);

		//	widgetContent.addView(widgetRoom, RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);

		}else if (widget.getType().equalsIgnoreCase("category")) {
			addListCategory(inflater, widgetContent, widgetContainer, widget);
			...
			songTitle.setTypeface(MainActivity.FONT_TITLE);
			...
			widgetContent.addView(linkWidget, RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
			LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 150);
			lParams.bottomMargin = 15;
			widgetContainer.setLayoutParams(lParams);
//			widgetContainer.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 250));
			...
			lParams.bottomMargin = 15;
			widgetContainer.setLayoutParams(lParams);
//			widgetContainer.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 200));
			widgetContent.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					FormContactFragment formContactFragment = FormContactFragment.newInstance();
			...
			public void run()
			{
				handler.post(new Runnable() {
					...
					public void run() {
						...
						RssServiceDashboardPhone serviceDashboard = new RssServiceDashboardPhone(DashboardFragmentPhone.this, lvRss , adapter, bar );
		...
		timer.schedule(new TimerTask()
		{
			...
			public void run()
			{
				handler.post(new Runnable() {
					...
					@Override
					public void run() {
						TextView timeTv = (TextView)map.get("time");
						SimpleDateFormat dateFormat = new SimpleDateFormat("KK:mm", Locale.FRANCE);
	...
	/**
	 * @param inflater
	 * @param widgetContainer2 
	 * @param widget
	 * @param widgetContainer
	 */
	public void addListCategory(LayoutInflater inflater,final RelativeLayout widgetContent, final RelativeLayout widgetContainer2, final Widget widget) {
		final View lyt = inflater.inflate(R.layout.widget_layout, null, false);
		...
		if (category != null) {
			...
			final MySplitAdapter adapter = new MySplitAdapter((MainActivity) getActivity(), communElements, colors, R.layout.divided_screen_item, 15/*R.layout.list_item_category_dashborad*/);
...
//					}
			...
			final ImageView img1 =	(ImageView)widgetContainer2.findViewById(R.id.show_widget);
			final com.euphor.paperpad.widgets.ArrowImageView img2 =	(com.euphor.paperpad.widgets.ArrowImageView)widgetContainer2.findViewById(R.id.hide_widget);
			...
			OnClickListener listener = new OnClickListener() {
				...
				public void onClick(View v) {
					//Toast.makeText(getActivity(), " This click is on  "+v.getTag()+" ", 1000).show();
					ListView l = map.get(widget.getId());
					if(v.getTag().equals("show")) {
						img2.setVisibility(View.VISIBLE);
						img1.setVisibility(View.GONE);
						
						LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnChildren(l)+ 60);
						lParams.bottomMargin = 15;
						widgetContainer2.setLayoutParams(lParams);

						widgetContainer2.requestLayout();
					}else {
						img1.setVisibility(View.VISIBLE);
						img2.setVisibility(View.GONE);

						LinearLayout.LayoutParams lParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getListViewHeightBasedOnNbrItemsChildren(l, 1) + 60);
						lParams.bottomMargin = 15;
						widgetContainer2.setLayoutParams(lParams);
		...
		widgetContainer2.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
	...
	public class DownloadMeteo extends AsyncTask<String, Integer, Forecast>{
		...
		protected Forecast doInBackground(String... params) {
			...
			String dashString = Utils.retrieveJson(params[0]);
            if(dashString == null) return null;
		...
		protected void onPostExecute(Forecast result) {
			Realm r = Realm.getInstance(getActivity());
			result = r.where(Forecast.class).findFirst();

			if(result!=null)
				Log.i(LOG_TAG, result.getTimezone()+" "+ result.getLatitude()+", "+result.getLongitude());
	...
	public class DownloadRoomService extends AsyncTask<String, Integer, RoomService>{
		...
		protected RoomService doInBackground(String... params) {
			...
			if (roomString != null) {
                ...
                Realm  r = Realm.getInstance(getActivity());
                r.beginTransaction();
                roomServices =  r.createOrUpdateObjectFromJson(RoomService.class,roomString);
                r.commitTransaction();
		...
		protected void onPostExecute(RoomService result) {
			Log.e("ASYNC DashboardFragment Phone", "POST EXECUTE");
				...
				getActivity().runOnUiThread(new Runnable() {
					...
					public void run() {
						if (roomService.getRequests() != null && roomService.getRequests().size()>0) {
							...
							adapterRoomServ = new RoomServicesAdapter(null, colors, getActivity());
							listRoomService.setAdapter(adapterRoomServ);
							adapterRoomServ.notifyDataSetChanged();
						}
//						else {
...
//						}
	...
	private void fillNavigationBar( Feed feed) {
		...
		feedName.setTypeface(MainActivity.FONT_TITLE, Typeface.BOLD);
