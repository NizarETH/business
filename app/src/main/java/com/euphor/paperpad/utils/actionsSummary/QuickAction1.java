 ...
 */
public class QuickAction1/* extends PopupWindows implements PopupWindow.OnDismissListener*/

    {
      /*  private View mRootView;
        ...
        private List<ActionItem1> actionItems = new ArrayList<ActionItem1>();
        ...
        *//**
         ...
         * @param colors
         *//*
        public QuickAction1(Context context, int orientation, Colors colors) {
        super(context);
        ...
        drawable.setColorFilter(colors.getColor("FFFFFF"*//*colors.getBackground_color()*//*, "E2"), PorterDuff.Mode.MULTIPLY);//.getTitle_color()), Mode.MULTIPLY);
        ...
        if (drawableArrowDown != null) {
            drawableArrowDown.setColorFilter(colors.getColor("FFFFFF"*//*colors.getBackground_color()*//*, "CC"), PorterDuff.Mode.MULTIPLY);//colors.getTitle_color()), Mode.MULTIPLY);
//			drawableArrowDown.setAlpha(64);
        ...
        if (drawableArrowUp != null) {
            drawableArrowUp.setColorFilter(colors.getColor("FFFFFF"*//*colors.getBackground_color()*//*, "CC"), PorterDuff.Mode.MULTIPLY);//colors.getTitle_color()), Mode.MULTIPLY);colors.getTitle_color()), Mode.MULTIPLY);
        ...
        *//**
         ...
         *//*
    public ActionItem1 getActionItem(int index) {
...
//				container = mInflater.inflate(R.layout.price_action_item_horizontal, null);
    ...
    *//**
     ...
     * @param action  {@link ActionItem}
     *//*
    public void addViewItem(ActionItem1 action) {
        actionItems.add(action);
        ...
        drawable.setColorFilter(colors.getColor(colors.getForeground_color()), PorterDuff.Mode.MULTIPLY);
...
//		quickActionItemRL.setBackgroundColor(colors.getColor("FFFFFF"*//*colors.getBackground_color()*//*, "CC"));
    ...
    *//**
    ...
    public interface OnActionItemClickListener {
        public abstract void onItemClick(QuickAction1 source, int pos, int actionId);
    }
