...
import com.euphor.paperpad.widgets.zoomableview.ScaleHandler.ScaleListener;
...
public class ZoomViewScalable extends ZoomViewTouchable implements ScaleListener {
    ...
    public ZoomViewScalable(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMinScale = a.getFloat(R.styleable.com_zoomableview_ZoomView_minScaleFactor_, 0.66667f);
        mMaxScale = a.getFloat(R.styleable.com_zoomableview_ZoomView_maxScaleFactor_, 5f);
